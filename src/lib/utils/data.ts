...
export const fallbackExperiences: Experience[] = [
  ...
  },
  {
    ...
    title: "Frontend Engineer (Program Pelatihan Intensif)",
    location: "Remote",
    startDate: "2022-02",
    endDate: "2022-07",
    isCurrent: false,
...
export const fallbackStats: Stat[] = [
  { _id: "stat-1", label: "Karyawan Dikelola", value: "138+", context: "Aktif, lintas site Modernland", order: 1 },
  { _id: "stat-2", label: "Perangkat Dikelola", value: "180+", context: "6 gedung kantor, 8 show unit", order: 2 },
  { _id: "stat-3", label: "Efisiensi Anggaran", value: "175M", context: "Rp/tahun dari optimasi lisensi", order: 3 },
  { _id: "stat-4", label: "Penghematan Infra", value: "90M", context: "Rp/tahun eliminasi server lokal", order: 4 },
  { _id: "stat-5", label: "Dokumen ISO", value: "49", context: "Lintas 7 departemen", order: 5 },
  { _id: "stat-6", label: "Workflow SOAR", value: "4", context: "CrowdStrike Falcon otomasi", order: 6 },
];
